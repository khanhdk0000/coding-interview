...
sol = Solution()
# print(sol.minimumSubarrayLength([1,2,3], 2)) # 2
# print(sol.minimumSubarrayLength([2,1,8], 10)) # 2
# print(sol.minimumSubarrayLength([1,2], 0)) # 2
print(sol.minimumSubarrayLength([1,2,32,21], 55)) # 2
